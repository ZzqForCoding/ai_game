...
class Client(Iface):
    ...
    def remove_player(self, player):
        ...
        """
        self.send_remove_player(player)
        return self.recv_remove_player()

    def send_remove_player(self, player):
...
class Processor(Iface, TProcessor):
    ...
    def process_add_player(self, seqid, iprot, oprot):
        ...
        result = add_player_result()
        try:
            result.success = self._handler.add_player(args.player)
    ...
    def process_remove_player(self, seqid, iprot, oprot):
        ...
        result = remove_player_result()
        try:
            result.success = self._handler.remove_player(args.player)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
