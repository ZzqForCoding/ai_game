    ...
    <div class="playground">
        ...
        <div v-if="flag === 'pk'" class="userinfo">
            ...
            <div class="userinfo-container">
                ...
                <div class="body" :style="$store.state.pk.a_id == $store.state.user.id ? 'background-color: #F94848;' : 'background-color: #4876EC;'">
                    <div class="eye" />
                    <div class="eye" />
                </div>
                <div class="user-profile">
        ...
        <div v-else-if="flag === 'record'" class="userinfo">
            ...
            <div class="userinfo-container">
                ...
                <div class="body" style="background-color: #F94848;">
                    <div class="eye" />
                    <div class="eye" />
                </div>
                <div class="user-profile">
